...
public final class Reflection
{
  ...
  public static synchronized Object getHandle(Object paramObject)
  {
    try
    {
      return getMethod(paramObject.getClass(), "getHandle", new Class[0]).invoke(paramObject, new Object[0]);
    } catch (Exception localException) {
      localException.printStackTrace(); }
    return null;
  }
  ...
  public static synchronized Field getField(Class<?> paramClass, String paramString)
  {
    Object localObject;
    ...
    if (!_loadedFields.containsKey(paramClass)) {
      ...
      _loadedFields.put(paramClass, localObject);
    } else {
  ...
  public static synchronized Method getMethod(Class<?> paramClass, String paramString, Class<?>... paramVarArgs)
  {
    ...
    ArrayWrapper localArrayWrapper = new ArrayWrapper(paramVarArgs);
    ...
    for (Method localMethod : paramClass.getMethods())
      if ((localMethod.getName().equals(paramString)) && (Arrays.equals(paramVarArgs, localMethod.getParameterTypes()))) {
